...
<tr>
    <td style="width: 200px;">
        <img width="50" src="<?= BASE_URL .'/'. $movie->preview()?>" alt="<?php echo $movie->name() ?>">
    </td>
    ...
    <td>
        <div class="dropdown d-flex justify-content-end">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a class="dropdown-item" href="<?=BASE_URL?>/admin/movies/update?id=<?php echo $movie->id() ?>">
                ...
                <li>
                    <form action="<?=BASE_URL?>/admin/movies/destroy" method="post">
